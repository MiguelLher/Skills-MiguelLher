...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        ...
        const speakOutput = locale.startsWith('es')
            ? '¡Bienvenido al conversor de unidades! Puedes pedir convertir entre el sistema métrico decimal y el sistema inglés. Por ejemplo, di "Convierte 5 kilómetros a millas" o "Convierte 10 metros a pies".'
            : 'Welcome to the unit converter! You can ask to convert between the metric system and the imperial system. For example, say "Convert 5 kilometers to miles" or "Convert 10 meters to feet".';
...
const HelpIntentHandler = {
    ...
    handle(handlerInput) {
        const locale = handlerInput.requestEnvelope.request.locale;
        const speakOutput = locale.startsWith('es')
            ? 'Puedes pedirme que convierta unidades diciendo, "Convierte 5 kilómetros a millas".'
            : 'You can ask me to convert units by saying, "Convert 5 kilometers to miles".';
...
const FallbackIntentHandler = {
    ...
    handle(handlerInput) {
        const locale = handlerInput.requestEnvelope.request.locale;
        const speakOutput = locale.startsWith('es')
            ? 'Lo siento, no sé eso. Puedes pedirme que convierta unidades diciendo, "Convierte 5 kilómetros a millas".'
            : 'Sorry, I don\'t know that. You can ask me to convert units by saying, "Convert 5 kilometers to miles".';
